...
#   I simply recorded YouTube videos of Baby Groot using a ScreenFlow screencast, edited out 
#   video, cropped the sound, then exported the audio. I then downloaded Audacity and
#   used this product to lower the sound quality to 22,050 kHz and 16 bit. If you search online
#   you can find several good Audacity tutorials. You can likely also record sound from video playing
#   on your phone or computer using iOS video capture or QuickTime for the Mac.
